...
const images = [
  ...
  },
  {
    ...
    description:
      "Providing essential health services to underserved communities.",
  },
];
...
const HeroCarousel = () => {
  ...
  return (
    <div className="relative h-[75vh]">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-[#001F3F] via-transparent to-[#001F3F] flex items-center justify-center">
