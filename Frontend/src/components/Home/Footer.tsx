...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-[#001F3F] to-[#003366] text-white py-6 px-6 shadow-2xl pt-32 my-auto">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col md:flex-row items-center space-x-6">
          ...
          <div className="flex flex-col space-y-4">
            <h3 className="text-lg font-semibold text-center my-4 md:my-0 md:text-left">
      ...
      <div className="text-center mt-6 pt-4 border-t border-white/20">
        <p className="text-sm opacity-80">
          © {new Date().getFullYear()} Renu Sharma HealthCare & Education
