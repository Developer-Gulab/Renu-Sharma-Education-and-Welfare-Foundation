...
SimpleMarquee.propTypes = {
  children: PropTypes.node.isRequired,
  className: PropTypes.string,
  direction: PropTypes.oneOf(["left", "right", "up", "down"]),
  baseVelocity: PropTypes.number,
  slowdownOnHover: PropTypes.bool,
  slowDownFactor: PropTypes.number,
  slowDownSpringConfig: PropTypes.object,
  useScrollVelocity: PropTypes.bool,
  scrollAwareDirection: PropTypes.bool,
  scrollSpringConfig: PropTypes.object,
  ...
  dragVelocityDecay: PropTypes.number,
  dragAwareDirection: PropTypes.bool,
  dragAngle: PropTypes.number,
