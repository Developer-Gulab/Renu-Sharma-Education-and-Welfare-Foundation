        ...
        <div className="container mx-auto px-4 md:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
            ...
            <div className="aspect-w-4 aspect-h-5 relative" data-aos="zoom-in">
              <div className="w-full h-[500px] rounded-2xl shadow-2xl overflow-hidden group">
                <div className="w-full h-full bg-gradient-to-br from-yellow-200 to-yellow-400 flex items-center justify-center transform transition-all duration-500 group-hover:scale-105">
                  <h1 className="text-4xl md:text-5xl font-bold text-black group-hover:text-white transition-colors duration-300 text-center px-4">Co-Founder 1</h1>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="aspect-w-4 aspect-h-5 relative" data-aos="fade-right">
              <div className="w-full h-[500px] rounded-2xl shadow-2xl overflow-hidden group">
                <div className="w-full h-full bg-gradient-to-br from-yellow-200 to-yellow-400 flex items-center justify-center transform transition-all duration-500 group-hover:scale-105">
                  <h1 className="text-4xl md:text-5xl font-bold text-black group-hover:text-white transition-colors duration-300 text-center px-4">Co Founder 2</h1>
                </div>
              </div>
            </div>
            <div data-aos="fade-left" className="text-center">
