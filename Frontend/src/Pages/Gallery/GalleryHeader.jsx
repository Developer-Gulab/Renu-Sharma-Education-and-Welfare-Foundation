...
export default function GalleryHeader() {
  ...
  useEffect(() => {
    console.log("Rendering GalleryMid for category:", selectedCategory);
  }, [selectedCategory]);
  ...
  return (
    <>
      ...
      <hr className="w-1/2 mx-auto mt-12 bg-black-700 h-1 "></hr>
      {/* Conditionally Render GalleryMid */}
      {selectedCategory && <GalleryMid selectedCategory={selectedCategory}  scrollToRef={sectionRef}/>}
